...
from funasr.download.name_maps_from_hub import name_maps_hf, name_maps_openai


def download_model(**kwargs):
    hub = kwargs.get("hub", "hf")
    if hub == "ms" or hub == "modelscope":
        raise ValueError("ModelScope is not supported in this version. Please use hub='hf' or hub='openai'.")
